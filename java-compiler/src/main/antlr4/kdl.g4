...
value: methodCall | arrayLength| literal | VARNAME | CONSTNAME | indexAccess | subSequence | R_NULL | newObject;
...
clazz: TYPE CLASSNAME BODY_OPEN (constant | field | main | methodDefinition)* BODY_CLOSE;
